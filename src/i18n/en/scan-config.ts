...
export const messages: Record<TScanConfigActivity, Record<string, string>> = {
  ...
  [ScanConfigActivity.Process]: {
    CoordinateCountFailed: 'An error occurred generating the processing campaign coordinates',
    ScanConfigGenerateGridFailed: 'An error occurred generating the processing campaign',
    ScanConfigGenerateGridCampaignIdFailed: 'An error occurred updating the processing',
    Generate: 'Generate process(es)',
    New: 'New processing campaign',
    CopyCampaignId: 'Copy processing campaign ID',
    LowFunds:
      'The project does not have enough credits to run the processing, please add credits and try again',
    GenericFailed: 'We are having trouble running the processing, please try again later',
  },
