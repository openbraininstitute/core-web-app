...
const triggerRefetchRecentAtom = atom(null, (get, set) => set(refetchRecentTriggerAtom, {}));

const refetchPublicTriggerAtom = atom<{}>({});
const triggerRefetchPublicAtom = atom(null, (get, set) => set(refetchPublicTriggerAtom, {}));

const refetchPersonalTriggerAtom = atom<{}>({});
const triggerRefetchPersonalAtom = atom(null, (get, set) => set(refetchPersonalTriggerAtom, {}));
