      ...
      <div className="border-neutral-4 flex w-full flex-col gap-6 border p-6">
        <div className="flex flex-col">
          ...
          <Form.Item
            ...
            labelAlign="left"
            className={classNames('mb-0', synapticInputOpened && 'border-neutral-4 border')}
          >
            <Select
              showSearch
              ...
              className={classNames(
                ...
                '[&_.ant-select-dropdown]:top-[4px]! [&_.ant-select-dropdown]:right-auto! [&_.ant-select-dropdown]:bottom-auto! [&_.ant-select-dropdown]:left-0!',
