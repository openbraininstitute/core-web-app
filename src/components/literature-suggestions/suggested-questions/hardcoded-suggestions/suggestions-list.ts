export const SuggestionsListPerRegion: Record<string, string[]> = {
  ...
  'Neuron density': [
    ...
    'What are the latest methods for quantifying neuron density in {rodent/human} brains? ',
    'Are there any recent studies comparing neuron density between different rodents and humans?',
  ],
