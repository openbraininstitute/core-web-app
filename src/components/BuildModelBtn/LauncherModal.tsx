...
export default function LauncherModal({
    ...
    return (
      ...
      >
        <div className="flex flex-col items-center">
          <h4 className="text-primary-7 mt-20 mb-2">We are setting up a couple of things...</h4>
          <h4 className="text-primary-7 mt-2 mb-2">Please wait</h4>
  ...
  return (
    <Modal
      ...
      styles={{ mask: maskStyle }}
    >
      <div className="text-primary-7 mt-4 mb-4">
