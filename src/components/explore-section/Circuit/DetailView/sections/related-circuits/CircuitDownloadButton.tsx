...
export default function CircuitDownloadButton({
    ...
    return (
        <a
            href={link}
            type="button"
            className="fixed bottom-10 right-[97px] flex h-20 w-[160px] items-center justify-center text-white bg-primary-8 text-xl transition-bottom duration-300 ease-in-out"
            style={{
