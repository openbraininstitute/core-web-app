...
import ColorRamp from '@/components/explore-section/reconstruction-morphology/morpho-viewer/color-map';
import Scalebar from '@/components/explore-section/reconstruction-morphology/morpho-viewer/scalebar';
import Settings from '@/components/explore-section/reconstruction-morphology/morpho-viewer/settings';
import Warning from '@/components/explore-section/reconstruction-morphology/morpho-viewer/warning';
import { useMorphoViewerSettings } from '@/components/explore-section/reconstruction-morphology/morpho-viewer/hooks/settings';
import { useSignal } from '@/components/explore-section/reconstruction-morphology/morpho-viewer/hooks/signal';
...
export default function MorphoViewer({ className, swc }: MorphoViewerProps) {
