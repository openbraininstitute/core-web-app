...
import ColorInput from '@/components/explore-section/reconstruction-morphology/morpho-viewer/settings/colors-legend/color-input';
...
export default function ColorsLegend({ className, painter }: ColorsLegendProps) {
