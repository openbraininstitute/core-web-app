...
export function HelpIcon({ className, ...props }: React.SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <title>Help</title>
      <path
        d="M21.5312 -0.000948202H18.3333C9.5989 -0.0165735 2.1933 6.42612 0.999964 15.0777L0.401007 19.5048C-3.33488e-05 22.4266 2.04687 25.1141 4.96874 25.5152C7.8854 25.911 10.5781 23.8641 10.9739 20.9475L11.6666 16.5204C12.1198 13.1767 14.9636 10.6819 18.3333 10.6663H21.5312C24.5885 10.6663 27.2656 12.7184 28.0468 15.6767C28.828 18.6297 27.5259 21.7444 24.8645 23.2548L23.1197 24.2548C17.6874 27.3537 14.3333 33.1297 14.3333 39.3854V41.7188C14.3333 44.6667 16.7188 47.0521 19.6666 47.0521C22.6145 47.0521 25 44.6667 25 41.7188V39.3854C24.9896 36.9688 26.2917 34.7344 28.4011 33.5469L30.1458 32.5469C37.0365 28.6511 40.427 20.5991 38.4062 12.9483C36.3802 5.29718 29.4478 -0.0205464 21.5316 0.000386942L21.5312 -0.000948202Z"
        fill="currentColor"
      />
      <path
        d="M11.9866 63.1351C11.9866 58.8976 15.4217 55.4551 19.6666 55.4551C21.7066 55.4551 23.6716 56.2727 25.1116 57.7202C26.5516 59.1676 27.3541 61.1326 27.3466 63.1726V64.1551C27.3466 68.4 23.9116 71.8351 19.6666 71.8351C15.4217 71.8351 11.9866 68.4 11.9866 64.1551V63.1351Z"
        fill="currentColor"
      />
    </svg>
  );
