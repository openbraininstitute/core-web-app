...
import { resolveExecutions } from '@/entity-configuration/domain/simulation/utils';
...
const SCALE = CircuitScaleDictionary.Region;
...
export const RegionCircuitSimulation: EntityCoreTypeConfig<
  ICircuitSimulationCampaign,
