import { getSingleNeuronSynaptomeSimulationIOResult } from '@/api/entitycore/queries/simulation/single-neuron-synaptome-simulation';
...
export const SingleNeuronSynaptomeSimulation: EntityCoreTypeConfig<ISingleNeuronSynaptomeSimulation> =
  {
    ...
    asset: {
      ...
      configfile: 'single_neuron_synaptome_simulation_io_result',
    },
    isBookmarkable: true,
  } as const;
