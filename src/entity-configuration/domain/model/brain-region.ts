...
export const circuitScaleFilter = {
  scale__in: [CircuitScaleDictionary.Region],
};
export const BrainRegion: EntityCoreTypeConfig<ICircuit> = {
  group: EntityTypeGroup.Models,
  title: 'Brain Region',
  extendedType: ExtendedEntitiesTypeDict.BrainRegion,
  type: EntityTypeDict.Circuit,
  slug: EntitySlug.BrainRegion,
  api: {
    config: {
      allowedFacets: true,
