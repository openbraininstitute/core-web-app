...
import type { ISkeletonizationCampaign } from '@/api/entitycore/types/entities/skeletonization-campaign';
...
export const viewConfig: ListExpandedViewConfig<ISkeletonizationCampaign> = {
