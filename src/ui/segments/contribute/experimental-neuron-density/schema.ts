...
export const ExperimentalNeuronDensitySchema = z.object({
  ...
  mtype_class_id: z
    .string({ message: 'M-type class is optional' })
    .uuid()
    .optional(),
  etype_class_id: z
    .string({ message: 'E-type class is optional' })
    .uuid()
    .optional(),
...
export type TExperimentalNeuronDensityForm = z.infer<
  typeof ExperimentalNeuronDensitySchema
>;
