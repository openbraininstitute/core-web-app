    ...
    <div className="mb-5 h-full w-full">
      <Form.Item
        ...
        rules={[
          {
            required: true,
            validator: zodFieldValidator(ExperimentalNeuronDensitySchema, 'subject.name', form),
          },
        ]}
      >
        <Input
      ...
      <Form.Item
        ...
        rules={[
          {
            required: true,
            validator: zodFieldValidator(ExperimentalNeuronDensitySchema, 'subject.description', form),
          },
        ]}
      >
        <Input.TextArea
      ...
      <Form.Item
        ...
        rules={[
          {
            required: true,
            validator: zodFieldValidator(ExperimentalNeuronDensitySchema, 'subject.sex', form),
          },
        ]}
      >
        <SexFormInput />
      ...
      <Form.Item
        ...
        rules={[
          {
            required: true,
            validator: zodFieldValidator(ExperimentalNeuronDensitySchema, 'subject.species_id', form),
          },
        ]}
      >
        <SpeciesFormInput />
      ...
      <Form.Item
        ...
        rules={[
          {
            required: true,
            validator: zodFieldValidator(ExperimentalNeuronDensitySchema, 'subject.strain_id', form),
          },
        ]}
      >
        <StrainFormInput />
      ...
      <div className="flex w-full items-center justify-center gap-2">
        <Form.Item
          ...
          rules={[
            {
              required: true,
              validator: zodFieldValidator(ExperimentalNeuronDensitySchema, 'subject.age_period', form),
            },
          ]}
        >
          <AgePeriodFormInput />
          ...
          rules={[
            {
              ...
              validator: zodFieldValidator(ExperimentalNeuronDensitySchema, 'subject.age_value', form),
            },
          ]}
        >
          <InputNumber
      ...
      <div className="flex w-full items-center justify-center gap-2">
          ...
          rules={[
            {
              ...
              validator: zodFieldValidator(ExperimentalNeuronDensitySchema, 'subject.age_min', form),
            },
          ]}
          className="w-full"
        >
        ...
        <Form.Item
          ...
          rules={[
            {
              required: !isSingleAgeMode,
              validator: zodFieldValidator(ExperimentalNeuronDensitySchema, 'subject.age_max', form),
            },
          ]}
          className="w-full"
        >
      ...
      <Form.Item
        ...
        rules={[
          {
            required: true,
            validator: zodFieldValidator(ExperimentalNeuronDensitySchema, 'subject.weight', form),
          },
        ]}
        className="w-full"
      >
