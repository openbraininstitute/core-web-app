  ...
  return (
    <Form.Item
      ...
      rules={[
        {
          required: true,
          validator: zodFieldValidator(ElectricalCellRecordingSchema, 'subject_id', form),
        },
      ]}
    >
      <SubjectDropdown />
    ...
    <div className="mb-5 h-full w-full">
      <Form.Item
        ...
        rules={[
          {
            required: true,
            validator: zodFieldValidator(ElectricalCellRecordingSchema, 'subject.name', form),
          },
        ]}
      >
        <Input
      ...
      <Form.Item
        ...
        rules={[
          {
            required: true,
            validator: zodFieldValidator(ElectricalCellRecordingSchema, 'subject.description', form),
          },
        ]}
      >
        <Input.TextArea
      ...
      <Form.Item
        ...
        rules={[
          {
            required: true,
            validator: zodFieldValidator(ElectricalCellRecordingSchema, 'subject.sex', form),
          },
        ]}
      >
        <SexFormInput />
      ...
      <Form.Item
        ...
        rules={[
          {
            required: true,
            validator: zodFieldValidator(ElectricalCellRecordingSchema, 'subject.species_id', form),
          },
        ]}
      >
        <SpeciesFormInput />
      ...
      <Form.Item
        ...
        rules={[
          {
            required: true,
            validator: zodFieldValidator(ElectricalCellRecordingSchema, 'subject.strain_id', form),
          },
        ]}
      >
        <StrainFormInput />
      ...
      <div className="flex w-full items-center justify-center gap-2">
        <Form.Item
          ...
          rules={[
            {
              required: true,
              validator: zodFieldValidator(ElectricalCellRecordingSchema, 'subject.age_period', form),
            },
          ]}
        >
          <AgePeriodFormInput />
          ...
          rules={[
            {
              ...
              validator: zodFieldValidator(ElectricalCellRecordingSchema, 'subject.age_value', form),
            },
          ]}
        >
          <InputNumber
      ...
      <div className="flex w-full items-center justify-center gap-2">
          ...
          rules={[
            {
              ...
              validator: zodFieldValidator(ElectricalCellRecordingSchema, 'subject.age_min', form),
            },
          ]}
          className="w-full"
        >
        ...
        <Form.Item
          ...
          rules={[
            {
              required: !isSingleAgeMode,
              validator: zodFieldValidator(ElectricalCellRecordingSchema, 'subject.age_max', form),
            },
          ]}
          className="w-full"
        >
      ...
      <Form.Item
        ...
        rules={[
          {
            required: true,
            validator: zodFieldValidator(ElectricalCellRecordingSchema, 'subject.weight', form),
          },
        ]}
        className="w-full"
      >
