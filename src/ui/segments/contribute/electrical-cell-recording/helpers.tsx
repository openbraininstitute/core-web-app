...
export const ElectricalCellRecordingSchema = z.object({
  setup: z.object({
    ...
    // --- FIXED: These fields are now correctly placed inside the 'setup' object ---
    // String field for recording_location (optional)
    recording_location: z.string().optional().nullable(),

    // String field for recording_type (optional)
    recording_type: z.string().optional().nullable(),

    // String field for recording_origin (optional, with default value)
    recording_origin: z.string().optional().nullable().default('in_vitro'),
    // ----------------------------------------------------------------------------
  }),
  ...
  ljp: z
    ...
    .optional()
    .nullable(),
  // --- Fields removed from root level (now in setup) ---

  // Float field for temperature (optional)
  temperature: z
    .number({
  ...
  // String field for comment (optional)
  comment: z.string().optional().nullable(),

  // UUID string field for stimuli_id (optional)
  stimuli_id: z.string().uuid({ message: 'Stimuli ID must be a valid UUID' }).optional().nullable(),
