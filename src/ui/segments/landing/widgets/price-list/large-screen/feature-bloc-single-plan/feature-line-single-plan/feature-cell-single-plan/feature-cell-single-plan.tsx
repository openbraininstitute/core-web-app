...
import styles from './feature-cell-single-plan.module.css';

interface FeatureCellSinglePlanProps {
  feature: ContentForPricingFeatureItem;
  plan: ContentForPricingPlan;
  available: boolean;
}

export default function FeatureCellSinglePlan({
  feature,
  plan,
  available,
}: FeatureCellSinglePlanProps) {
