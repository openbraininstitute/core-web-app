...
import { CellTypeContentForGlossaryItem } from '@/components/documentation/type';
...
export default function GlossarySection() {
  ...
  const dataContent = useSanityContentForExperimentsModels();
  const artifactContent = useSanityContentForArtifactTypes();
