...
function normalizePlan(plan: PlanV2): PlanV2 {
  return {
    ...
    ai_assistant_features: Array.isArray(plan.ai_assistant_features) ? plan.ai_assistant_features : [],
    ...
    monthly_subscriptions: Array.isArray(plan.monthly_subscriptions) ? plan.monthly_subscriptions : [],
