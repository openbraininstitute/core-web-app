...
export function detailViewPaginationClass(variant: TViewVariant) {
  ...
  return cn(
    'text-light',
    // prev / next and page-jump controls
    '[&_.ant-pagination-prev]:text-light! [&_.ant-pagination-next]:text-light!',
    '[&_.ant-pagination-jump-prev]:text-light! [&_.ant-pagination-jump-next]:text-light!',
    '[&_.ant-pagination-prev_button]:text-light! [&_.ant-pagination-next_button]:text-light!',
    '[&_.ant-pagination-item-container]:text-light! [&_.ant-pagination-item-ellipsis]:text-light!',
    // item link box and jump links
    '[&_.ant-pagination-item-link]:border-light/35! [&_.ant-pagination-item-link]:bg-transparent! [&_.ant-pagination-item-link]:text-light!',
    '[&_.ant-pagination-jump-prev_.ant-pagination-item-link]:text-light! [&_.ant-pagination-jump-next_.ant-pagination-item-link]:text-light!',
    '[&_.ant-pagination-item-link:hover]:bg-light/10!',
    '[&_.ant-pagination-item-link_.anticon]:text-light! [&_.ant-pagination-item-link-icon]:text-light! [&_.ant-pagination-item-link_svg]:fill-current [&_.ant-pagination-item-link_svg]:text-light!',
    '[&_.ant-pagination-item-link::before]:border-light! [&_.ant-pagination-item-link::before]:text-light! [&_.ant-pagination-item-link::after]:border-light! [&_.ant-pagination-item-link::after]:text-light!',
    // disabled state
    '[&_.ant-pagination-disabled_.ant-pagination-item-link]:border-light/20! [&_.ant-pagination-disabled_.ant-pagination-item-link]:text-light/40!',
    '[&_.ant-pagination-disabled_.ant-pagination-item-link_.anticon]:text-light/40! [&_.ant-pagination-disabled_.ant-pagination-item-link_svg]:text-light/40!',
    // simple pager input + slash
    '[&_.ant-pagination-simple-pager]:text-light!',
    '[&_.ant-pagination-simple-pager_input]:border-light/35! [&_.ant-pagination-simple-pager_input]:bg-light! [&_.ant-pagination-simple-pager_input]:text-primary-8!',
    '[&_.ant-pagination-slash]:mx-1 [&_.ant-pagination-slash]:text-light! [&_.ant-pagination-simple-pager>span]:mx-1 [&_.ant-pagination-simple-pager>span]:text-light!'
  );
}
