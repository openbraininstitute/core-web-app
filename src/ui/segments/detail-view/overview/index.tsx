...
export default async function Overview({
  ...
  // Synaptome (beta) is a scale='single' circuit. It has no `circuit_visualization`
  // image, so it never reaches the `visualizations` block above — it gets the same
  // interactive 3D viewer the Simulate page uses instead.
