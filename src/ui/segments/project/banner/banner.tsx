...
import { Form, type FormProps, type GetRef, Input } from 'antd';
...
export function ProjectCard(): ReactElement {
  ...
  const nameRef = useRef<GetRef<typeof Input.TextArea>>(null);
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 h-full w-full">
        <div className="flex h-full w-full flex-col p-6 md:w-[calc(100%-6px)] md:pt-20 lg:p-6 lg:md:w-[calc(var(--container-2xl)-14px)] xl:max-w-3xl">
