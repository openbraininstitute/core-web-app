...
export function Wallet() {
  ...
  const [
    ...
    { data: roles, isLoading: loadingRoles },
  ] = useQueries({
    queries: [
      {
      ...
      },
      {
        ...
        select: (res: VlmUserGroupsResponse) =>
          makeRoles(res, virtualLabId, projectId),
      },
    ],
  });
    ...
    <Tooltip>
      ...
      >
        ...
        <p className="hyphens-auto">
          Credits transferred to this project from the virtual lab.
        </p>
      </TooltipContent>
    </Tooltip>
  );
