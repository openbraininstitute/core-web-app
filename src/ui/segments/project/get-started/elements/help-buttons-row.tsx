        ...
        {ITEMS.map(({ id, label, Icon }) => {
          ...
          return (
            <button
              ...
              className={cn(
                'group relative flex aspect-square w-[56px] shrink-0 cursor-pointer select-none flex-col items-center justify-center gap-[3px] overflow-hidden rounded-lg bg-white',
