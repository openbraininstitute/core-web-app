        ...
        <div className="h-full w-full p-6 md:w-[calc(100%-6px)] md:pt-20 lg:p-6 lg:md:w-[calc(var(--container-2xl)-14px)] xl:max-w-3xl">
          ...
          <div>
            {isEditing ? (
              ...
              <p className="text-base leading-relaxed text-white/90 transition-all duration-300 lg:text-lg">
                {isPending ? variables.description : result.data.project.description}
              </p>
            )}
          </div>
        </div>
