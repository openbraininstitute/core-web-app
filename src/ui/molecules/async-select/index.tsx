...
export function AsyncSelect<R extends Partial<PaginationFilter & SearchFilter>, T = unknown>({
  ...
  const rowVirtualizer = useVirtualizer({
    ...
    enabled: open && options.length > 0 && !!parent,
  ...
  return (
    <Popover open={open} onOpenChange={handleOpenChange}>
      ...
      <PopoverContent
        className={cn(
          'border-neutral-2 animate-fade-in bg-white p-0 shadow-md transition-all duration-200',
          clsx?.content
        )}
        style={{
      ...
      >
        ...
        >
          ...
          {isLoading && options.length === 0 ? (
            ...
            <div className="animate-fade-in flex h-full w-full items-center justify-center py-5">
              ...
              {rowVirtualizer.getVirtualItems().map((virtualItem) => {
                ...
                return (
                  <div
                    ...
                    className="animate-fade-in mb-1 flex items-center justify-start"
                  >
                    <button
                      type="button"
                      aria-label={label}
          ...
          {isFetchingNextPage && (
            <div className="animate-fade-in sticky bottom-0 left-0 z-[99999] flex items-center justify-center gap-2 py-3">
