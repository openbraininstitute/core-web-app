export const EntityTypeDict = {
  ...
  EModelOptimizationCampaign: 'emodel_optimization_campaign',
  EModelOptimizationConfig: 'emodel_optimization_config',
  EModelOptimizationResult: 'emodel_optimization_result',
