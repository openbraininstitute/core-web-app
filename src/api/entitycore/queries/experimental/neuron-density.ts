...
const measurementSchema = z.object({
  ...
  value: z
    .number({ message: 'Measurement value must be a number' }) // Assuming 'value' should be a number (like 123)
    .min(0, { message: 'Measurement value must be non-negative' }), // Example constraint
});
