...
export const experimentalNeuronDensitySchema: IGridSchema<Row> = {
  ...
  columns: [
    ...
    speciesColumn<Row>(),
    mtypeColumn<Row>({ width: { minWidth: 125, resizable: true } }),
    etypeColumn<Row>({ width: { minWidth: 120, resizable: true } }),
    densityColumn<Row>({ width: { width: 130 } }),
    numberOfMeasurementsColumn<Row>({ width: { width: 130, minWidth: 110 } }),
    nameColumn<Row>(),
