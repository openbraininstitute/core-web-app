  ...
  return (
    <div className="flex min-w-56 flex-col gap-2 p-2">
      ...
      <div className="mt-1 flex justify-between border-t border-gray-100 pt-2">
        ...
        <button
          type="button"
          className="rounded bg-primary-6 px-2 py-0.5 text-xs text-white hover:bg-primary-7"
...
function SetEditor({
  ...
  return (
    <div className="flex max-h-72 min-w-60 flex-col gap-2">
      <Input
        size="small"
        allowClear
        placeholder="Search…"
      ...
      <div className="flex justify-between text-xs">
        ...
        <button type="button" className="text-primary-6" onClick={() => onChange([])}>
          Clear
        </button>
      </div>
      <div className="flex flex-col gap-1 overflow-auto">
        {loading ? (
          ...
          <div className="py-2 text-center text-xs text-gray-400">No options</div>
        ) : (
          visible.map((o) => (
            <div key={o.id} className="flex flex-col gap-0.5">
              ...
              <label className={cn('flex items-center gap-2 text-sm')} title={o.label}>
                <Checkbox
