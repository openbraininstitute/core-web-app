  ...
  useEffect(() => {
    ...
    loadAfferentSynapses({
      ...
      .then((loaded) => {
        ...
        // own, labelled by the population since the type is what is unknown.
        // Counted over untyped populations only: numbering it by its place in
        // `loaded` would both move its colour when a population ahead of it
