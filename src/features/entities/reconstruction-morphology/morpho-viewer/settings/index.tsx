...
import ColorsLegend from '@/features/entities/reconstruction-morphology/morpho-viewer/settings/colors-legend';
import DendriteThickness from '@/features/entities/reconstruction-morphology/morpho-viewer/settings/dendrite-thickness';
import ThicknessMode from '@/features/entities/reconstruction-morphology/morpho-viewer/settings/thickness-mode';
import ColorMode from '@/features/entities/reconstruction-morphology/morpho-viewer/settings/color-mode';
