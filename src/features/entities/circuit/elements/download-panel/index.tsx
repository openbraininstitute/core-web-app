...
import NodesAndEdgesConfig from '@/features/entities/circuit/elements/download-panel/nodes-edges-config';
    ...
    <div className="relative w-full">
      ...
      >
        ...
        <div className="flex w-full flex-col gap-y-12 px-8 pb-10">
          <ConnectivityMatrices key="ConnectivityMatrices" circuit={circuit} />
          <NodesAndEdgesConfig key="NetworksContent" circuit={circuit} />
        </div>
      </div>
    </div>
  );
