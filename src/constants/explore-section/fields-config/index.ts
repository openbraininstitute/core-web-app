...
import {
  ...
  NEW_EXPERIMENTAL_DATA_FIELDS_CONFIG,
} from '@/constants/explore-section/fields-config/experimental-data';
...
import {
  ...
  NEW_COMMON_FIELDS_CONFIG,
} from '@/constants/explore-section/fields-config/common';
...
const NEW_EXPLORE_FIELDS_CONFIG: ExploreFieldsConfigProps<EntityCore> = {
  ...NEW_COMMON_FIELDS_CONFIG,
  ...NEW_EXPERIMENTAL_DATA_FIELDS_CONFIG,
};
...
export { NEW_EXPLORE_FIELDS_CONFIG };
